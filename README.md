...
> Ethereum HD Wallet derivations from [mnemonic] seed in Go (golang). Implements the [go-ethereum](https://github.com/simplechain-org/go-simplechain) [`accounts.Wallet`](https://github.com/simplechain-org/go-simplechain/blob/master/accounts/accounts.go) interface.
