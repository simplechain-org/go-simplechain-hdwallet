...
.PHONY: deps/fix
deps/fix:
	@cp -r "${GOPATH}/src/github.com/simplechain-org/go-simplechain/crypto/secp256k1/libsecp256k1" "vendor/github.com/simplechain-org/go-simplechain/crypto/secp256k1/"
